...
import sonbahar from "./resimler/sonbahar.png"
...
class Sonbahar extends React.Component {
                            ...
                            <Grid.Column>
                                <Card fluid>
                                    <Card.Content>
                                        ...
                                        <Card.Meta>
                                            <span className='date'>Sonbahar Mevsiminin Analizi</span>
                                        </Card.Meta>
                                    </Card.Content>
                                    <Image className="logo" src={sonbahar} wrapped ui={false} />
